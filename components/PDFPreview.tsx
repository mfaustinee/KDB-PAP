      ...
      <div className="bg-white w-full max-w-4xl shadow-2xl rounded-none my-8 animate-in zoom-in-95 duration-300 relative">
        ...
        <div className="p-16 text-slate-900 bg-white min-h-[1056px] print:p-8" id="formal-agreement">
          ...
          <div className="flex flex-col items-center text-center mb-10">
            <div className="bg-emerald-700 p-3 rounded-xl mb-4 print:bg-emerald-700">
              <ShieldCheck className="w-12 h-12 text-white" />
            </div>
            <h1 className="text-xl font-black uppercase tracking-tight text-slate-900">Kenya Dairy Board</h1>
            <p className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] mt-1">Quality Dairy for Health & Wealth</p>
