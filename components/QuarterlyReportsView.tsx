...
export const QuarterlyReportsView: React.FC<QuarterlyReportsViewProps> = ({ clients, returns }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div id="kdb-quarterly-report-printable" className="bg-white p-2 sm:p-4 rounded-none sm:rounded-2xl md:rounded-3xl border-y sm:border border-slate-100 shadow-sm print:shadow-none print:border-none print:p-0 space-y-10 text-slate-800">
