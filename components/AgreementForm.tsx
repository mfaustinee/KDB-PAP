...
export const AgreementForm: React.FC<AgreementFormProps> = ({ debtors, onSubmit }) => {
  ...
  const handleVerify = (e: React.FormEvent) => {
    ...
    if (found) {
      ...
      setFormData(prev => ({ ...prev, ...found, installments: found.installments.map(i => ({ ...i })) }));
      setStep(1);
    } else {
