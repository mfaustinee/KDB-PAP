          ...
          {step === 0 && (
            <div className="max-w-md mx-auto py-12 space-y-10">
              ...
              <form onSubmit={handleVerify} className="space-y-4">
                <div className="space-y-1.5"><label htmlFor="lookupPermit" className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-4">Permit Number</label><input id="lookupPermit" name="lookupPermit" required placeholder="KDB/MB/0001/0001234/2024" value={lookupPermit} onChange={e => setLookupPermit(e.target.value)} className="w-full px-6 py-4 rounded-2xl border bg-slate-50 focus:bg-white focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all font-bold" /></div>
                <div className="space-y-1.5"><label htmlFor="lookupSecret" className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-4">Authorized Phone / Debit Note No</label><input id="lookupSecret" name="lookupSecret" required type="password" placeholder="••••••••" value={lookupSecret} onChange={e => setLookupSecret(e.target.value)} className="w-full px-6 py-4 rounded-2xl border bg-slate-50 focus:bg-white focus:ring-4 focus:ring-emerald-500/10 outline-none transition-all font-bold" /></div>
          ...
          {step === 1 && (
            <div className="space-y-8 animate-in slide-in-from-right-4 duration-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-1.5"><label htmlFor="location" className="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-4">Premise Physical Location *</label><input id="location" name="location" required value={formData.location || ''} onChange={e => updateField('location', e.target.value)} className="w-full px-5 py-3 rounded-2xl border bg-white focus:ring-4 focus:ring-emerald-500/5 font-bold outline-none" placeholder="e.g. Plot 42, Kisumu Rd" /></div>
                <div className="space-y-1.5"><label htmlFor="clientEmail" className="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-4">Signatory Contact Email *</label><input id="clientEmail" name="clientEmail" required type="email" value={formData.clientEmail || ''} onChange={e => updateField('clientEmail', e.target.value)} className="w-full px-5 py-3 rounded-2xl border bg-white focus:ring-4 focus:ring-emerald-500/5 font-bold outline-none" placeholder="manager@business.com" /></div>
                <div className="md:col-span-2 space-y-1.5"><label htmlFor="tel" className="block text-[10px] font-black text-slate-400 uppercase tracking-widest ml-4">Authorized Phone No *</label><input id="tel" name="tel" required value={formData.tel || ''} onChange={e => updateField('tel', e.target.value)} className="w-full px-5 py-3 rounded-2xl border bg-white focus:ring-4 focus:ring-emerald-500/5 font-bold outline-none" placeholder="0712 345 678" /></div>
              </div>
